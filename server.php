...
if (isset($_POST['reg_user'])) {
  ...
  if (count($errors) == 0) {
  	...
  	$query = "INSERT INTO user(uname, email, pass,phone,hno,city,state)VALUES('$username', '$email', '$password','$phno','$hno','$city','$state')";
...
if (isset($_POST['login_user'])) {
  ...
  if (count($errors) == 0) {
  	$results = mysqli_query($db, "SELECT * FROM user WHERE uname='$username' AND pass='$password'");
